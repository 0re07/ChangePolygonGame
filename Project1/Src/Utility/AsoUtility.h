...
public:
	...
	//
	static VECTOR GetClosestPosTriangleBeta(
		const VECTOR& tPos1, const VECTOR& tPos2, const VECTOR& tPos3, const VECTOR& sPos1);
	...
	//	三角形と球の衝突判定
	static bool IsHitTriangleSphere(const VECTOR& tPos1, const VECTOR& tPos2, const VECTOR& tPos3, const VECTOR& sPos1, float radius);

	//	三角形と線分の当たり判定
	static bool IsHitTriangleLine(const VECTOR& tPos1, const VECTOR& tPos2, const VECTOR& tPos3, const VECTOR& lPos1, const VECTOR& lPos2);

	//
	static AABB GetAABBTriangle(const VECTOR& tPos1, const VECTOR& tPos2, const VECTOR& tPos3);

	//
	static AABB GetAABBSphere(const VECTOR& sPos1, float radius);

	//
	static void DrawAABB(const AABB& aabb, int color);
